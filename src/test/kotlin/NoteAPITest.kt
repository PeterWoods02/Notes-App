...
class NoteAPITest {
    ...
    inner class AddNotes {
        ...
        fun `adding a Note to a populated list adds to ArrayList`() {
            val newNote = Note("Study Lambdas", 1, "College", false,LocalDate.now())
    ...
    inner class UpdateNotes {
        ...
        fun `updating a note that does not exist returns false`(){
            assertFalse(populatedNotes!!.updateNote(6, Note("Updating Note", 2, "Work", false,LocalDate.now())))
            assertFalse(populatedNotes!!.updateNote(-1, Note("Updating Note", 2, "Work", false,LocalDate.now())))
            assertFalse(emptyNotes!!.updateNote(0, Note("Updating Note", 2, "Work", false,LocalDate.now())))
        }
        ...
        fun `updating a note that exists returns true and updates`() {
            ...
            assertTrue(populatedNotes!!.updateNote(4, Note("Updating Note", 2, "College", false,LocalDate.now())))
        ...
        fun numberOfNotesByCategoryCalculatedCorrectly() {
            assertEquals(
                "college: 1\n" +
                    ...
                    "work: 2\n" +
                    "hobby: 1",
                populatedNotes!!.numberOfNotesByCategory())
